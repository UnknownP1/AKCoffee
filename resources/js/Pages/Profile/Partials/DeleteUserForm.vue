    ...
    <section class="space-y-6">
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Setelah akun dihapus, semua data akan hilang permanen. Harap masukkan password Anda untuk mengonfirmasi penghapusan.
                </p>
                <div class="mt-6">
                ...
                <div class="mt-6 flex justify-end">
                    ...
                    <DangerButton class="ms-3" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" @click="deleteUser">Hapus Akun</DangerButton>
                </div>
            </div>
        </Modal>
    </section>
